...
import com.fsof.ref_client.databinding.FragmentChangeInfoBinding
...
class ChangeInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChangeInfoBinding.inflate(inflater, container, false)
        return binding.root
    }
